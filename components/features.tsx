      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">在数据中邂逅海洋</h2>
            <p className="text-xl text-gray-400">
              我们通过可视化技术和数据分析，将海洋的深度信息转化为你可以触摸的知识。从温度变化到生物多样性，从洋流动态到深海奥秘，每一份数据都是对海洋深处的一次探索。
            </p>
          </div>
          ...
          <div
            ...
            <div
              ...
              <h4 className="h4 mb-2">丰富数据</h4>
              <p className="text-lg text-gray-400 text-center">
                汇集全球海洋数据，涵盖温度、盐度、海流等多维度信息，为你提供全面的海洋洞察。
              </p>
            </div>
            ...
            <div
              ...
              <h4 className="h4 mb-2">动态可视</h4>
              <p className="text-lg text-gray-400 text-center">
                采用动态图表和3D模型，直观展示海洋数据变化，带来沉浸式的观察体验。
              </p>
            </div>
            ...
            <div
              ...
              <h4 className="h4 mb-2">深度分析</h4>
              <p className="text-lg text-gray-400 text-center">
                结合最新研究，深入分析海洋现象，让你对海洋生态有更加深刻的理解。
              </p>
            </div>
            ...
            <div
              ...
              <h4 className="h4 mb-2">实时更新</h4>
              <p className="text-lg text-gray-400 text-center">
                数据持续更新，确保你可以随时获取到最新的海洋环境信息和科学发现。
              </p>
            </div>
            ...
            <div
              ...
              <h4 className="h4 mb-2">互动体验</h4>
              <p className="text-lg text-gray-400 text-center">
                提供互动查询和个性化视图设置，让你能根据兴趣深入探索海洋数据。
              </p>
            </div>
            ...
            <div
              ...
              <h4 className="h4 mb-2">科学普及</h4>
              <p className="text-lg text-gray-400 text-center">
                结合教育资源，深入浅出地讲解复杂数据，普及海洋科学知识。
              </p>
            </div>
          </div>
        </div>
